...
export function Marquee3D() {
  return (
    <div className="relative flex h-full w-96 flex-col items-center justify-center gap-4 overflow-hidden rounded-lg border border-neutral-800 bg-black px-20 md:shadow-xl">
      <div className="flex flex-row gap-4 [perspective:300px]">
        <Marquee
          className="h-[32rem] justify-center [--duration:60s] [--gap:1rem]"
          vertical
          style={{
            transform:
