export default function Footer(){
    ...
    return (
        <footer className="text-gray-500 bg-black px-4 py-5 w-[90%] l-20 mx-auto md:px-8">
            <div className="gap-6 justify-between md:flex">
                <div className="flex-1">
                    <div className="max-w-xs">
                        <img src="/vigil_logo.jpeg" className="w-32" />
            ...
            <div className="mt-8 py-6 border-t items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2024 Vigil All rights reserved.
                </div>
                <div className="mt-6 sm:mt-0">
                    <ul className="flex items-center space-x-4">
                        <li className="w-10 h-10 border rounded-full border-gray-700 flex items-center justify-center">
