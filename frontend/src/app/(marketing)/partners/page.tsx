...
export default function Portfolio() {
  ...
  /**
   * UPDATED: Div 1 Scale
   * - From scrollYProgress=0.0 → 0.1 => scale stays at 1 (100%)
   * - From scrollYProgress=0.1 → 0.2 => scale transitions 1 → 0.8
   */
  const div1Scale = useTransform(scrollYProgress, [0.0, 0.1, 0.2], [1, 1, 0.8]);

  /**
   * Div 1 Y
   * Same logic as before, just keep the existing range
   */
  ...
  return (
    <>
      ...
      <ReactLenis root options={{ lerp: 0.1, duration: 1.5 }}>
        {/*
          1) “Projects” section in normal flow.
             Takes up the full viewport, so it's what you see first.
        */}
        <section
          className="
            relative
        ...
        {/**
         * 2) Giant container that drives your
         *    fixed-position motion divs as you scroll
         */}
        <div className="relative h-[1000vh] w-full z-10">
          ...
          <motion.div
            className="
              ...
              origin-center z-20 pointer-events-none
            "
            style={{ scale: div4Scale, y: div4Y }}
          >
